...
class UTMScriptingImportCommand: NSCreateCommand, UTMScriptable {
    ...
    enum ScriptingError: Error, LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
            case .notReady: return NSLocalizedString("Lattice VM is not ready to accept commands.", comment: "UTMScriptingAppDelegate")
            case .fileNotFound: return NSLocalizedString("A valid Lattice VM file must be specified.", comment: "UTMScriptingAppDelegate")
