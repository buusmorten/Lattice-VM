    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                }.help("Export all arguments as a text file. This is only for debugging purposes as Lattice VM's built-in QEMU differs from upstream QEMU in supported arguments.")
                Spacer()
                let customSelected = selected.intersection(customUuids)
