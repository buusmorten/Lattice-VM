    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                Text("Your support is the driving force that helps Lattice VM stay independent. Your contribution, no matter the size, makes a significant difference. It enables us to develop new features and maintain existing ones. Thank you for considering a donation to support us.")
                    .padding()
                if #available(iOS 15, *) {
                    StoreView()
                } else {
            ...
            }.navigationTitle("Support Lattice VM")
