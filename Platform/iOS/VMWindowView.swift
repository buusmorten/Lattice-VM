...
struct VMWindowView: View {
    ...
    var body: some View {
        ...
        .alert(item: $state.alert, content: { type in
            ...
            case .terminateApp:
                return Alert(title: Text("Are you sure you want to exit Lattice VM?"), primaryButton: .destructive(Text("Yes")) {
            ...
            case .memoryWarning:
                return Alert(title: Text("Running low on memory! Lattice VM might soon be killed by iOS. You can prevent this by decreasing the amount of memory and/or JIT cache assigned to this VM"), dismissButton: .cancel(Text("OK")) {
