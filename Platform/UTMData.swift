...
@MainActor class UTMData: ObservableObject {
    ...
    init() {
        self.busyQueue = DispatchQueue(label: "Lattice VM Busy Queue", qos: .userInitiated)
...
extension UTMDataError: LocalizedError {
    var errorDescription: String? {
        ...
        case .importFailed:
            return NSLocalizedString("Cannot import this VM. Either the configuration is invalid, created in a newer version of Lattice VM, or on a platform that is incompatible with this version of Lattice VM.", comment: "UTMData")
        case .importParseFailed:
