...
class UTMDownloadVMTask: UTMDownloadTask {
    ...
    static private func name(for url: URL) -> String {
        ...
        var nameWithoutZIP = "Lattice VM Virtual Machine"
    ...
    private class UnzipNoUTMFileError: Error {
        var errorDescription: String? {
            NSLocalizedString("There is no Lattice VM file in the downloaded ZIP archive.", comment: "Error shown when importing a ZIP file from web that doesn't contain a Lattice VM Virtual Machine.")
        }
    }
