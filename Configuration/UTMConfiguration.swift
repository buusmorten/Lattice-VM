...
extension UTMConfigurationError: LocalizedError {
    var errorDescription: String? {
        ...
        case .versionTooHigh: return NSLocalizedString("This configuration is saved with a newer version of Lattice VM and is not compatible with this version.", comment: "UTMConfiguration")
